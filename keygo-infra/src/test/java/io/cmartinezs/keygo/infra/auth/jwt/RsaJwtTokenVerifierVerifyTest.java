...
class RsaJwtTokenVerifierVerifyTest {
  ...
  @Test
  void verify_withMalformedToken_shouldThrowException() {
    assertThrows(InvalidRefreshTokenException.class, () ->
        verifier.verify("malformed.token", List.of(signingKey))
    );
  }

  @Test
  void verify_withEmptyKeyList_shouldThrowException() {
    assertThrows(InvalidRefreshTokenException.class, () ->
        verifier.verify(validToken, List.of())
    );
  }

  @Test
  void verify_withNullKeyList_shouldThrowException() {
    assertThrows(NullPointerException.class, () ->
        verifier.verify(validToken, null)
    );
  }
}