 ...
 *
 * <p>Se utiliza cuando un usuario se registra o cambia su email. El template incluye: - Código de
 * verificación - Enlace directo (si disponible) - Información de expiración
 *
 * <p>Variables esperadas en el comando: - verificationCode: código de 6 dígitos o más -
 * expiresInMinutes: minutos de validez del código - verificationLink (opcional): enlace directo -
...
public class EmailValidationStrategy extends EmailStrategy {
  ...
  public Map<String, Object> getTemplateVariables() {
    ...
    log.debug("EmailValidationStrategy rendered with variables: {}", variables.keySet());
