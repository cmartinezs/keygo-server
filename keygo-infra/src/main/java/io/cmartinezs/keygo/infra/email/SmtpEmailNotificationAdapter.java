...
public class SmtpEmailNotificationAdapter implements EmailNotificationPort {
  ...
  @Override
  public void sendContractVerificationEmail(String toEmail, String recipientName, String verificationCode, UUID contractId) {
    try {
      MimeMessage message = mailSender.createMimeMessage();
      MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
      helper.setFrom(fromAddress);
      helper.setTo(toEmail);
      helper.setSubject(appName + " — Verifica tu contrato");
  ...
  String buildContractVerificationBody(String recipientName, String verificationCode, UUID contractId) {
    return """
        <!DOCTYPE html>
        <html lang="es">
        <head>
          <meta charset="UTF-8" />
          <meta name="viewport" content="width=device-width, initial-scale=1.0" />
          <title>Verifica tu contrato — %1$s</title>
        </head>
        <body style="margin:0;padding:0;background-color:#f1f5f9;font-family:Inter,ui-sans-serif,system-ui,-apple-system,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
          <table width="100%%" cellpadding="0" cellspacing="0" style="background-color:#f1f5f9;padding:40px 0;">
            <tr>
                ...
                <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%%;">
                  ...
                  <tr>
                    <td style="background:linear-gradient(135deg,#4f46e5 0%%,#6366f1 100%%);border-radius:12px 12px 0 0;padding:36px 40px;text-align:center;">
                      ...
                      <p style="margin:12px 0 0;color:rgba(255,255,255,0.85);font-size:14px;">Verificación de contrato</p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="background:#ffffff;padding:40px 40px 32px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
                      ...
                      <p style="margin:0 0 28px;font-size:15px;color:#475569;line-height:1.6;">
                        Has iniciado el proceso de contratación en <strong style="color:#4f46e5;">%1$s</strong>.
                      ...
                      <table width="100%%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;">
                        <tr>
                          <td style="background:#f8fafc;padding:14px 20px;">
                            <span style="font-size:12px;font-weight:600;color:#94a3b8;letter-spacing:0.5px;text-transform:uppercase;">ID de tu contrato</span>
                            <p style="margin:6px 0 0;font-size:13px;font-weight:600;color:#0f172a;font-family:'Courier New',Courier,monospace;word-break:break-all;">%4$s</p>
                            <p style="margin:6px 0 0;font-size:12px;color:#64748b;line-height:1.5;">
                              Guarda este ID. Si cierras el navegador antes de completar el proceso,
                              podrás retomarlo desde donde lo dejaste.
                            </p>
                          </td>
                        </tr>
                      </table>
                        ...
                        <tr>
                          <td style="background:#f8fafc;border-left:4px solid #10b981;border-radius:0 8px 8px 0;padding:14px 18px;">
                            <p style="margin:0;font-size:13px;color:#475569;line-height:1.5;">
                              ...
                              Si no lo usas en ese tiempo, podrás solicitar uno nuevo usando el ID de tu contrato.
                            </p>
                          </td>
                        </tr>
                      </table>
                      ...
                      <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.5;">
                        Si no iniciaste este proceso, puedes ignorar este mensaje con toda seguridad.
                      </p>
                    </td>
                  </tr>
        ...
        """.formatted(appName, recipientName, verificationCode, contractId);
  }
