-- =============================================================================
-- V17: Seed — Planes de billing para keygo-platform
--
-- Crea el stack canónico FREE / STARTER / BUSINESS / ENTERPRISE para la
-- ClientApp "keygo-platform" (ID: 11111111-1111-1111-1111-333333333333).
-- subscriber_type = TENANT (modelo B2B).
--
-- Todos los planes son públicos y ACTIVE. Precio en MXN, facturación MONTHLY.
-- UUIDs estables para re-ejecución idempotente (ON CONFLICT DO UPDATE).
--
-- Plan IDs:
...
--
-- Version IDs (v1.0):
--   FREE:       33333333-3333-3333-3333-100000000001
--   STARTER:    33333333-3333-3333-3333-100000000002
--   BUSINESS:   33333333-3333-3333-3333-100000000003
--   ENTERPRISE: 33333333-3333-3333-3333-100000000004
-- =============================================================================
...
VALUES
  ('33333333-3333-3333-3333-100000000001', '22222222-2222-2222-2222-100000000001', '1.0', 'MXN', 'MONTHLY',    0.00, 0.00,  0, '2026-01-01', 'ACTIVE'),
  ('33333333-3333-3333-3333-100000000002', '22222222-2222-2222-2222-100000000002', '1.0', 'MXN', 'MONTHLY',  299.00, 0.00, 14, '2026-01-01', 'ACTIVE'),
  ('33333333-3333-3333-3333-100000000003', '22222222-2222-2222-2222-100000000003', '1.0', 'MXN', 'MONTHLY',  999.00, 0.00, 14, '2026-01-01', 'ACTIVE'),
  ('33333333-3333-3333-3333-100000000004', '22222222-2222-2222-2222-100000000004', '1.0', 'MXN', 'MONTHLY', 3999.00, 0.00, 30, '2026-01-01', 'ACTIVE')
...
-- Límites muy bajos, sin SLA garantizado
-- ────────────────────────────────────────────────────────────────────────────
...
VALUES
  ...
  (gen_random_uuid(), '33333333-3333-3333-3333-100000000002', 'SOCIAL_LOGIN',       'BOOLEAN', NULL,  'NONE',  'HARD', FALSE),
...
VALUES
  ...
  (gen_random_uuid(), '33333333-3333-3333-3333-100000000003', 'MAX_MONTHLY_TOKENS', 'QUOTA',   500000, 'MONTH', 'HARD', TRUE),
...
VALUES
  ...
  (gen_random_uuid(), '33333333-3333-3333-3333-100000000004', 'SLA_UPTIME_PCT',     'QUOTA',   999,  'NONE',  'HARD', TRUE),
  (gen_random_uuid(), '33333333-3333-3333-3333-100000000004', 'AUDIT_LOG_DAYS',     'QUOTA',   NULL, 'NONE',  'SOFT', TRUE)
ON CONFLICT DO NOTHING;
