...
> Archivo de comportamiento para **GitHub Copilot Chat / agent mode** en este repositorio.
...
Estas instrucciones aplican a **Copilot Chat y agent mode**. No afectan las sugerencias inline.
