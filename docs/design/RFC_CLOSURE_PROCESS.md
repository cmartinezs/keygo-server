...
Decisión 3: "JWT contiene tenant_slug en claim"
  → Impacta: docs/design/api/AUTHORIZATION_PATTERNS.md (será creado Sprint 2)
...
| JWT + tenant_slug | (nuevo) AUTHORIZATION_PATTERNS.md | § JWT Claims | Crear + documentar |
| Hosted login sesión | (nuevo) PRODUCTION_RUNBOOK.md | § Deployment | Crear + documentar |
