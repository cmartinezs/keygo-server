...
sequenceDiagram
    ...
    API->>SPA: 5. Return 200:<br/>{<br/>  sub: uuid,<br/>  email: 'user@example.com',<br/>  name: 'John Doe',<br/>  picture: 'https://...',<br/>  phoneNumber: '+1234567890',<br/>  birthdate: '1990-01-15',<br/>  locale: 'es-MX',<br/>  updated_at: timestamp<br/>}

    SPA->>User: 6. Show profile form (pre-filled)

    User->>SPA: 7. Edit name + locale<br/>Click "Save"

    SPA->>API: 8. PATCH /api/v1/tenants/{slug}/account/profile<br/>Header: Bearer {access_token}<br/>body: {<br/>  name: 'Juan García',<br/>  locale: 'es-MX',<br/>  picture: 'https://new-pic.jpg'<br/>}
...
sequenceDiagram
    ...
    API->>SPA: 5. Return 200:<br/>{<br/>  sessions: [<br/>    {<br/>      sessionId: uuid,<br/>      userAgent: 'Mozilla/5.0 (Windows; Chrome)',<br/>      isCurrent: true,<br/>      createdAt: '2026-04-05 10:30',<br/>      lastActivityAt: '2026-04-05 11:45'<br/>    },<br/>    {<br/>      sessionId: uuid,<br/>      userAgent: 'Mozilla/5.0 (iPhone; Safari)',<br/>      isCurrent: false,<br/>      createdAt: '2026-04-04 14:20',<br/>      lastActivityAt: '2026-04-04 16:00'<br/>    }<br/>  ]<br/>}
...
sequenceDiagram
    ...
    SPA->>API: 4. POST /api/v1/tenants/{slug}/account/change-password<br/>Header: Bearer {access_token}<br/>body: {<br/>  currentPassword: '...',<br/>  newPassword: '...'<br/>}
...
sequenceDiagram
    ...
    API->>SPA: 6. Return 200:<br/>{<br/>  roles: [<br/>    {<br/>      appName: 'MobileApp',<br/>      appId: uuid,<br/>      assignedRoles: ['Admin', 'Viewer'],<br/>      scopes: ['openid', 'profile', 'email']<br/>    },<br/>    {<br/>      appName: 'Dashboard',<br/>      appId: uuid,<br/>      assignedRoles: ['Editor'],<br/>      scopes: ['openid', 'profile']<br/>    }<br/>  ],<br/>  globalAccess: 'USER_TENANT'<br/>}
...
sequenceDiagram
    ...
    API->>SPA: 4. Return 200:<br/>{<br/>  emailAlertsEnabled: true,<br/>  emailInvoices: true,<br/>  emailSecurityAlerts: true,<br/>  smsEnabled: false<br/>}
