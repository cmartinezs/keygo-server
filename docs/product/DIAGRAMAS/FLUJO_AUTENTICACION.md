...
sequenceDiagram
    ...
    SPA->>KeyGo: 12. POST /oauth2/token<br/>body: {<br/>  grant_type: authorization_code,<br/>  code: auth_code_xyz,<br/>  code_verifier: (original 128 chars),<br/>  client_id: xxx,<br/>  client_secret: yyy<br/>}
    ...
    KeyGo->>SPA: 15. Return:<br/>{<br/>  access_token,<br/>  id_token,<br/>  refresh_token,<br/>  expires_in: 3600<br/>}
...
sequenceDiagram
    ...
    SPA->>KeyGo: 2. POST /oauth2/token<br/>body: {<br/>  grant_type: refresh_token,<br/>  refresh_token: (old token),<br/>  client_id: xxx,<br/>  client_secret: yyy<br/>}
    ...
    alt Replay Attack Detected (T-035)
        ...
        KeyGo->>SPA: 8. Return:<br/>{<br/>  access_token: (new),<br/>  refresh_token: (new),<br/>  expires_in: 3600<br/>}
...
sequenceDiagram
    ...
    SPA->>KeyGo: 2. POST /oauth2/revoke<br/>Header: Authorization: Bearer {access_token}<br/>body: {<br/>  token: (refresh_token)<br/>}
...
sequenceDiagram
    ...
    SPA->>KeyGo: 19. POST /account/reset-password<br/>body: {<br/>  resetCodeId,<br/>  resetCode,<br/>  newPassword<br/>}
