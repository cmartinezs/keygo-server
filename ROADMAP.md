...
| T-065 | Agregar `fieldErrors` (lista de campos inválidos) en `ErrorData` cuando `origin=CLIENT_REQUEST` y `clientRequestCause=USER_INPUT` | `keygo-api` | Mejora UX de formularios y reduce ambigüedad al mostrar validaciones por campo en frontend |
